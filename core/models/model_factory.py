...
from core.models import predrnn, predrnn_v2, action_cond_predrnn, action_cond_predrnn_v2, image_cond_predrnn_v2
...
class Model(object):
    def __init__(self, configs):
        ...
        networks_map = {
            ...
            'image_cond_predrnn_v2': image_cond_predrnn_v2.RNN,
        }
    ...
    def train(self, frames, mask):
        ...
        #frames_tensor = frames.to(self.configs.device).float()
